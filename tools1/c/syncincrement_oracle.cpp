/*
  程序名：syncincrement_oracle.cpp，本程序是数据中心的公共功能模块，采用增量的方式同步MySQL数据库之间的表
  作者：吴惠明
*/
...
int main(int argc, char* argv[]){
    ...
    while (true)
    {
      if (_syncincrement_oracle(bcontinue)==false) EXIT(-1);
...
bool _syncincrement_oracle(bool& bcontinue){
  ...
  // insert into T_ZHOBTMIND2(obtid, ddatetime, t, p, u, wd, wf, r, vis, upttime, recid) select obtid, ddatetime, t, p, u, wd, wf, r, vis, upttime, keyid from T_ZHOBTMIND1@db132 where obtid in (:1, :2, :3);
