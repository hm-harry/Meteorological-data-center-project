/*
  程序名：syncincrement.cpp，本程序是数据中心的公共功能模块，采用增量的方式同步MySQL数据库之间的表
  作者：吴惠明
*/
#include "_tools.h"
