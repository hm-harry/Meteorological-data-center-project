/*
  程序名：syncincrementex_oracle.cpp，本程序是数据中心的公共功能模块，采用增量的方式同步Oracle数据库之间的表
...
int main(int argc, char* argv[]){
    ...
    while (true)
    {
      if (_syncincrementex_oracle(bcontinue)==false) EXIT(-1);
...
void _help(char* argv[]){
    ...
    // printf("Sample:/project/tools1/bin/procctl 10 /project/tools1/bin/syncincrementex_oracle /log/idc/syncincrementex_oracle_ZHOBTMIND2.log \"<localconnstr>scott/tiger@snorcl11g_130</localconnstr><remoteconnstr>qxidc/qxidcpwd@snorcl11g_132</remoteconnstr><charset>Simplified Chinese_china.AL32UTF8</charset><remotetname>T_ZHOBTMIND1</remotetname><localtname>T_ZHOBTMIND2</localtname><remotecols>obtid,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</remotecols><localcols>obtid,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</localcols><remotekeycol>keyid</remotekeycol><localkeycol>obtid</localkeycol><timetvl>2</timetvl><timeout>50</timeout><pname>syncincrementex_oracle_ZHOBTMIND2</pname>\"\n\n");

    // printf("       /project/tools1/bin/procctl 10 /project/tools1/bin/syncincrementex_oracle /log/idc/syncincrementex_oracle_ZHOBTMIND3.log \"<localconnstr>scott/tiger@snorcl11g_130</localconnstr><remoteconnstr>qxidc/qxidcpwd@snorcl11g_132</remoteconnstr><charset>Simplified Chinese_china.AL32UTF8</charset><remotetname>T_ZHOBTMIND1</remotetname><localtname>T_ZHOBTMIND3</localtname><remotecols>obtid,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</remotecols><localcols>obtid,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</localcols><where>and stid like '54%%%%'</where><remotekeycol>keyid</remotekeycol><localkeycol>obtid</localkeycol><timetvl>2</timetvl><timeout>50</timeout><pname>syncincrementex_oracle_ZHOBTMIND3</pname>\"\n\n");
...
bool _syncincrementex_oracle(bool& bcontinue){
  ...
  // 从本地表starg.localtname中获取自增字段的最大值，存放在maxkeyvalue全局变量中
