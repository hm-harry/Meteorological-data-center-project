/*
 程序名：my_inserttable.cpp.此程序演示开发框架MySQL数据库（修改表中的记录）
 作者：吴惠明
*/
...
int main(int argc, char* argv[]){
  ...
  */
    ...
    for(int ii = 0; ii < 5; ++ii){
        ...
        sprintf(stgirls.name, "西施%05dgirl", ii + 1); // 超女姓名name
        stgirls.weight = 45.25 + ii; // 体重weight
        sprintf(stgirls.btime, "2022-7-22 16:09:%02d", ii); // 报名时间btime
